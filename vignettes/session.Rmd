...
#> [1] microbenchmark_1.5.0 boot_1.3-31          betaMC_1.3.3        
#> 
#> loaded via a namespace (and not attached):
#>  [1] generics_0.1.4   tidyr_1.3.1      shape_1.4.6.1    lattice_0.22-7  
#>  [5] lme4_1.1-37      magrittr_2.0.4   mitml_0.4-5      evaluate_1.0.5  
#>  [9] grid_4.5.1       iterators_1.0.14 mice_3.18.0      foreach_1.5.2   
#> [13] jomo_2.7-6       rprojroot_2.1.1  glmnet_4.1-10    Matrix_1.7-3    
#> [17] nnet_7.3-20      backports_1.5.0  survival_3.8-3   purrr_1.1.0     
#> [21] rProject_0.0.21  codetools_0.2-20 reformulas_0.4.1 Rdpack_2.6.4    
#> [25] cli_3.6.5.9000   rlang_1.1.6      rbibutils_2.3    splines_4.5.1   
#> [29] pan_1.9          tools_4.5.1      nloptr_2.2.1     minqa_1.2.8     
#> [33] dplyr_1.1.4      broom_1.0.10     vctrs_0.6.5      R6_2.6.1        
#> [37] rpart_4.1.24     lifecycle_1.0.4  MASS_7.3-65      pkgconfig_2.0.3 
#> [41] pillar_1.11.1    glue_1.8.0       Rcpp_1.1.0       xfun_0.53       
#> [45] tibble_3.3.0     tidyselect_1.2.1 knitr_1.50       nlme_3.1-168    
#> [49] compiler_4.5.1
```
...
#> Mem:           251Gi        11Gi        64Gi       5.5Gi       183Gi       240Gi
#> Swap:             0B          0B          0B
#> Total:         251Gi        11Gi        64Gi
```
