## ---- test-external-betaMC-delta-r-sq-mc
lapply(
  X = 1,
  FUN = function(i,
                 text,
    ...
    df <- as.data.frame(df)
    object <- lm(y ~ ., data = df)
    mvn <- DeltaRSqMC(MC(object, R = R, type = "mvn"))
    adf <- DeltaRSqMC(MC(object, R = R, type = "adf"))
    hc0 <- DeltaRSqMC(MC(object, R = R, type = "hc0"))
    hc1 <- DeltaRSqMC(MC(object, R = R, type = "hc1"))
    hc2 <- DeltaRSqMC(MC(object, R = R, type = "hc2"))
    hc3 <- DeltaRSqMC(MC(object, R = R, type = "hc3"))
    hc4 <- DeltaRSqMC(MC(object, R = R, type = "hc4"))
    hc4m <- DeltaRSqMC(MC(object, R = R, type = "hc4m"))
    hc5 <- DeltaRSqMC(MC(object, R = R, type = "hc5"))
  ...
  text = "test-external-betaMC-delta-r-sq-mc",
  tol = 0.01,
  n = 100000L,
  p = 2,
  beta = 0.5,
